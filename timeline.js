function timeline() {
    ...
    const foreign = d3.select("g#menu-parcours").select("svg")
    ...
    const ul_timeline = container.append("xhtml:ul")
        .classed("timeline", true)
        .selectAll("li")
        .data(dataTimeline)
        .enter()
    const li_timeline = ul_timeline.append("xhtml:li")
        .classed("timeline-inverted", (d, i) => i % 2 == 1)

    li_timeline.append("xhtml:div")
        .classed("timeline-badge primary", true)
        .append("xhtml:a")
        .append("xhtml:i")
        .attr("class", "fa fa-dot-circle-o")
    const panel_timeline = li_timeline.append("xhtml:div")
        .classed("timeline-panel", true)
    const head_timeline = panel_timeline.append("xhtml:div")
        .classed("timeline-heading", true)
    head_timeline.append("xhtml:h3")
        .text(d => d.title)
    const body_timeline = panel_timeline.append("xhtml:div")
